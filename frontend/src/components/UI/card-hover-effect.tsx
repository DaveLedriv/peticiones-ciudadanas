...
export const Card = ({
  ...
  return (
    <div
      className={cn(
        "rounded-2xl h-full w-full p-4 overflow-hidden bg-background border border-border group-hover:border-primary relative z-20 transition-colors duration-300",
        className
      )}
    >
