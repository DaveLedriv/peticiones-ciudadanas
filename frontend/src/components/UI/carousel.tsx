  ...
  return (
    <div className="[perspective:1200px] [transform-style:preserve-3d]">
      ...
      >
        ...
        >
          <h2 className="text-lg md:text-2xl lg:text-4xl font-bold text-primary drop-shadow">
            {title}
          </h2>
          <div className="flex justify-center">
            <button className="mt-6 px-4 py-2 bg-primary text-white rounded-2xl hover:opacity-90 text-xs font-semibold shadow-lg transition">
              {button}
            </button>
          </div>
        </article>
...
const CarouselControl = ({
  ...
  <button
    className={`w-10 h-10 flex items-center mx-2 justify-center bg-muted text-foreground border-2 border-primary rounded-full hover:-translate-y-0.5 active:translate-y-0.5 transition duration-200 ${
